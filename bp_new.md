...
|Analysis
|Reported by: <a href=#ref-3>[3] </a><a href=#ref-6>[6] </a><a href=#ref-11>[11] </a>
|
|3
|Identify DSL usage
...
|Analysis
|Reported by: <a href=#ref-1>[1] </a><a href=#ref-5>[5] </a>
|
...
|44|Check constraints first| description|Implementation|Reported by: <a href=#ref-2>[2] </a>|
|68|Avoid debugging at source-code-level| description|Implementation|Reported by: <a href=#ref-7>[7] </a>|
|111|Target-Specific Generator Classes| description|Implementation|Reported by: <a href=#ref-10>[10] </a>|
|183|Turn DSM models into documentation| description|Implementation|Reported by: <a href=#ref-11>[11] </a>|
|184|Integrate handwritten code on file level| description|Implementation|Reported by: <a href=#ref-11>[11] </a>|
|185|Use autobuild for DSM models| description|Implementation|Reported by: <a href=#ref-11>[11] </a>|
|189|Parallel generators per prog. langugage| description|Implementation|Reported by: <a href=#ref-11>[11] </a>|
|191|One version for all| description|Implementation|Reported by: <a href=#ref-11>[11] </a>|
|193|Do not build generator to soon| description|Implementation|Reported by: <a href=#ref-11>[11] </a>|
|114|Generate all documents| description|Implementation|Reported by: <a href=#ref-12>[12] </a>|
|122|Stabilize design quickly| description|Implementation|Reported by: <a href=#ref-14>[14] </a>|
|119|Modularize transformations| description|Implementation|Reported by: <a href=#ref-14>[14] </a>|
|120|Consistent input to transformations| description|Implementation|Reported by: <a href=#ref-14>[14] </a>|
|42|Interpretation vs. code generation| description|Implementation|Reported by: <a href=#ref-2>[2] </a>|
|46|Control manually written code| description|Implementation|Reported by: <a href=#ref-2>[2] </a>|
|47|Care about generated code| description|Implementation|Reported by: <a href=#ref-2>[2] </a>|
|48|Make code true to the model| description|Implementation|Reported by: <a href=#ref-2>[2] </a>|
|49|Viewpoint aware processing| description|Implementation|Reported by: <a href=#ref-2>[2] </a>|
|50|Care about templates| description|Implementation|Reported by: <a href=#ref-2>[2] </a>|
|56|Effective Generators| description|Implementation|Reported by: <a href=#ref-3>[3] </a>|
|66|Avoid semiautomatic transformation| description|Implementation|Reported by: <a href=#ref-7>[7] </a>|
|82|Mapping grammars to recursive-descent reco| description|Implementation|Reported by: <a href=#ref-10>[10] </a>|
|90|Normalized Heterogeneous AST| description|Implementation|Reported by: <a href=#ref-10>[10] </a>|
|91|Irregular Heterogeneous AST| description|Implementation|Reported by: <a href=#ref-10>[10] </a>|
|92|Embedded Heterogeneous Tree Walker| description|Implementation|Reported by: <a href=#ref-10>[10] </a>|
|93|External Tree Visitor| description|Implementation|Reported by: <a href=#ref-10>[10] </a>|
|94|Tree Grammar| description|Implementation|Reported by: <a href=#ref-10>[10] </a>|
|95|Tree Pattern Matcher| description|Implementation|Reported by: <a href=#ref-10>[10] </a>|
|96|Symbol Table for Monolithic Scope| description|Implementation|Reported by: <a href=#ref-10>[10] </a>|
|97|Symbol Table for Nested Scopes| description|Implementation|Reported by: <a href=#ref-10>[10] </a>|
|98|Symbol Table for Data Aggregates| description|Implementation|Reported by: <a href=#ref-10>[10] </a>|
|99|Symbol Table for Classes| description|Implementation|Reported by: <a href=#ref-10>[10] </a>|
|83|LL(1) Recursive-Descent Lexer| description|Implementation|Reported by: <a href=#ref-10>[10] </a>|
|100|Computing Static Expression Types| description|Implementation|Reported by: <a href=#ref-10>[10] </a>|
|101|Automatic Type Promotion| description|Implementation|Reported by: <a href=#ref-10>[10] </a>|
|102|Enforcing Static Type Safety| description|Implementation|Reported by: <a href=#ref-10>[10] </a>|
|103|Enforcing Polymorphic Type Safety| description|Implementation|Reported by: <a href=#ref-10>[10] </a>|
|104|Syntax-Directed Interpreter| description|Implementation|Reported by: <a href=#ref-10>[10] </a>|
|105|Tree-Based Interpreter| description|Implementation|Reported by: <a href=#ref-10>[10] </a>|
|106|Bytecode Assembler| description|Implementation|Reported by: <a href=#ref-10>[10] </a>|
|107|Stack-Based Bytecode Interpreter| description|Implementation|Reported by: <a href=#ref-10>[10] </a>|
|108|Register-Based Bytecode Interpreter| description|Implementation|Reported by: <a href=#ref-10>[10] </a>|
|109|Syntax-Directed Translator| description|Implementation|Reported by: <a href=#ref-10>[10] </a>|
|84|LL(1) Recursive-Descent Parser| description|Implementation|Reported by: <a href=#ref-10>[10] </a>|
|110|Rule-Based Translator| description|Implementation|Reported by: <a href=#ref-10>[10] </a>|
|85|Backtracking Parser| description|Implementation|Reported by: <a href=#ref-10>[10] </a>|
|86|Memoizing Parser| description|Implementation|Reported by: <a href=#ref-10>[10] </a>|
|87|Predicated Parser| description|Implementation|Reported by: <a href=#ref-10>[10] </a>|
|88|Parse Tree| description|Implementation|Reported by: <a href=#ref-10>[10] </a>|
|89|Homogeneous AST| description|Implementation|Reported by: <a href=#ref-10>[10] </a>|
